...
function init_sidebar() {
  ...
  $SIDEBAR_MENU.find("a").on("click", function (e) {
    ...
    //Commenting below code and adding replacement for this
    /*a.is(".active") ? (a.removeClass("active active-sm"),
    ...
    //Replacement for Above Code [Custom_Code]
    if (a.is(".active") &&
      ($('.child_menu').css('display') == 'block' || $('.child_menu').css('display') == 'flex')) {
      //a.removeClass("active");
      $("ul:first", a).slideUp(function () {
        t()
      });
    } else if (a.is(".active-sm")) {
      //a.removeClass("active-sm");
      if ($('#submenu').hasClass('nav-small') && $(".child_menu").css('display')=='none')
        $("ul:first", a).slideDown(function () {
          t()
        });
      else
      ...
      if (a.parent().is(".child_menu"))
        $BODY.is("nav-sm") && (a.parent().is("child_menu") || o());
      else
        o();

      if (a.hasClass('nav-small')) {
        if ($('.nav-small').is('.active') || $('.nav-small').is('.active-sm'))
          $(".child_menu").css('display', 'none');

        $(".child_menu").children().removeClass('active');
        $(".child_menu").children().removeClass('active-sm');
    ...
    $MENU_TOGGLE.on("click", function () {
      ...
      //Part Of [Custom_Code]
      if ($('#submenu').hasClass('nav-small'))
        $('#submenu').removeClass('nav-small');
      else
        $('#submenu').addClass('nav-small');
        //$('#submenu').removeClass('active');
        //$('#submenu').removeClass('active-sm');
    }),
...
$(document).ready(function () {
  ...
  //Part Of [Custom_Code]
  $("#submenu .child_menu").click(function (e) {
    e.stopPropagation();
  });
  //Part Of [Custom_Code]
...
function init_flot_chart() {
  if (void 0 !== $.plot) {
    ...
    for (var e = [[gd(2012, 1, 1), 17], [gd(2012, 1, 2), 74], [gd(2012, 1, 3), 6], [gd(2012, 1, 4), 39], [gd(2012, 1, 5), 20], [gd(2012, 1, 6), 85], [gd(2012, 1, 7), 7]], a = [[gd(2012, 1, 1), 82], [gd(2012, 1, 2), 23], [gd(2012, 1, 3), 66], [gd(2012, 1, 4), 9], [gd(2012, 1, 5), 119], [gd(2012, 1, 6), 6], [gd(2012, 1, 7), 9]], t = [], o = 0; o < 30; o++)
      t.push([new Date(Date.today().add(o).days()).getTime(), Math.floor(21 * Math.random()) + 20 + o + o + 10]);
    var n = {
      grid: {
        show: !0,
        aboveData: !0,
...
function init_starrr() {
  "undefined" != typeof starrr && (console.log("init_starrr"),
    $(".stars").starrr(),
...
function init_JQVmap() {
  void 0 !== jQuery.fn.vectorMap && (console.log("init_JQVmap"),
...
function init_gauge() {
  if ("undefined" != typeof Gauge) {
    ...
    $("#gauge-text2").length && (n.maxValue = 9e3,
      n.animationSpeed = 32,
      n.set(2400),
...
function init_sparklines() {
  void 0 !== jQuery.fn.sparkline && (console.log("init_sparklines"),
...
function init_wysiwyg() {
  function a(e, a) {
    var t = "";
    "unsupported-file-type" === e ? t = "Unsupported format " + a : console.log("error uploading file", e, a),
  ...
  void 0 !== $.fn.wysiwyg && (console.log("init_wysiwyg"),
  ...
  if (void 0 !== $.fn.cropper) {
    ...
    $('[data-toggle="tooltip"]').tooltip(),
      ...
      $(".docs-toggles").on("change", "input", function () {
        ...
        i.data("cropper") && ("checkbox" === n ? (d[o] = t.prop("checked"),
      ...
      $(".docs-buttons").on("click", "[data-method]", function () {
        ...
        if (!t.prop("disabled") && !t.hasClass("disabled") && i.data("cropper") && o.method) {
          if (void 0 !== (o = $.extend({}, o)).target && (e = $(o.target),
            void 0 === o.option))
            try {
          ...
          switch (a = i.cropper(o.method, o.option, o.secondOption),
          o.method) {
            case "scaleX":
            case "scaleY":
            ...
            case "getCroppedCanvas":
              a && ($("#getCroppedCanvasModal").modal().find(".modal-body").html(a),
                n.hasClass("disabled") || n.attr("href", a.toDataURL()))
          }
    ...
    p ? m.change(function () {
      var e, a = this.files;
      i.data("cropper") && a && a.length && (e = a[0],
        /^image\/\w+$/.test(e.type) ? (u = p.createObjectURL(e),
          i.one("built.cropper", function () {
            p.revokeObjectURL(u)
          }).cropper("reset").cropper("replace", u),
          m.val("")) : window.alert("Please choose an image file."))
...
function init_InputMask() {
  void 0 !== $.fn.inputmask && (console.log("init_InputMask"),
    $(":input").inputmask())
}
function init_ColorPicker() {
  void 0 !== $.fn.colorpicker && (console.log("init_ColorPicker"),
    $(".demo1").colorpicker(),
    $(".demo2").colorpicker(),
...
function init_IonRangeSlider() {
  void 0 !== $.fn.ionRangeSlider && (console.log("init_IonRangeSlider"),
...
function init_daterangepicker_single_call() {
  void 0 !== $.fn.daterangepicker && (console.log("init_daterangepicker_single_call"),
...
function init_SmartWizard() {
  void 0 !== $.fn.smartWizard && (console.log("init_SmartWizard"),
    $("#wizard").smartWizard(),
...
function init_CustomNotification() {
  if (console.log("run_customtabs"),
    ...
    TabbedNotification = function (e) {
      ...
      document.getElementById("custom_notifications") ? ($("#custom_notifications ul.notifications").append("<li><a id='ntlink" + t + "' class='alert-" + e.type + "' href='#ntf" + t + "'><i class='fa fa-bell animated shake'></i></a></li>"),
        $("#custom_notifications #notif-group").append(a),
        t++,
        CustomTabs(e)) : alert("doesnt exists")
    }
      ,
...
function init_compose() {
  void 0 !== $.fn.slideToggle && (console.log("init_compose"),
...
function init_echarts() {
  if ("undefined" != typeof echarts) {
    ...
    if ($("#echart_world_map").length)
      echarts.init(document.getElementById("echart_world_map"), e).setOption({
        title: {
